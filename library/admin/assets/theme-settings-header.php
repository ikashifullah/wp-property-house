...
<!-- Themes setting > Header -->
	...
	<tr><th>
		...
		<h4><?php _e('Use search form on menu', 'javo_fr'); ?>
			<a href="#TB_inline?width=600&height=700&inlineId=header-search" class="thickbox"><img src="<?php echo get_template_directory_uri(); ?>/images/admin_zoom_in.png" class="zoom-icon"></a>
		</h4>
		<fieldset>
		...
		<h4><?php _e("Menu width","javo_fr"); ?>
			<a href="#TB_inline?width=600&height=700&inlineId=header-width" class="thickbox"><img src="<?php echo get_template_directory_uri(); ?>/images/admin_zoom_in.png" class="zoom-icon"></a>
		</h4>
		<fieldset>
...
<div id="header-width" style="display:none;">
     <p>
          <img src="<?php echo get_template_directory_uri(); ?>/images/header-width.gif" style="width:100%;">
     </p>
</div>
<div id="header-search" style="display:none;">
     <p>
          <img src="<?php echo get_template_directory_uri(); ?>/images/header-search.gif" style="width:100%;">
     </p>
</div>
