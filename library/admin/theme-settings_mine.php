...
class javo_theme_settings {
	...
	public function javo_theme_admin_enqueue(){
		...
		foreach($javo_enqueu_pages as $page => $args){
			...
			if( ("theme-settings_page_real-estate-settings-".$page == get_current_screen()-> id) || ("toplevel_page_real-estate-settings" == get_current_screen()-> id) ) {

				wp_enqueue_script("jquery-nouislider", get_template_directory_uri()."/js/jquery.nouislider.min.js", null, '1.0.0', true);
		...
		wp_enqueue_style("nouislider", get_template_directory_uri()."/css/jquery.nouislider.min.css");

		wp_enqueue_style("javo-themes-settings-css", get_template_directory_uri()."/css/javo_admin_theme_settings.css");
	...
	public function settings_page_initialize(){
		...
		foreach( $pages as $page => $value ){
			...
			$add_tabs .= sprintf("<li class='javo-opts-group-tab-link-li'>
				...
				<a href='javascript:void(0);' class='javo-opts-group-tab-link-a' tar='%s'>%s %s</a></li>",
		...
		<form id="javo_ts_form" onsubmit="return false">
			...
			<div class="updated">
				...
				<h3 style="display:inline-block;"><?php _e("Kashif Ullah - ", "javo_fr");?></h3>
			...
			<div class="javo_ts_header_div">
				...
				<div class="javo_ts_header logo">
					...
					<img src="<?php echo get_template_directory_uri();?>/images/property_house_logo.png" width="200">
			...
			<div class="javo_ts_header save_area">
					...
					<a href="https://kashifullahwebdeveloper.wordpress.com" target="_blank" class="button button-default"><?php _e('Support', 'javo_fr');?></a>

					<a href="https://kashifullahwebdeveloper.wordpress.com" target="_blank" class="button button-default"><?php _e('Documentation', 'javo_fr');?></a>

					<input value="Save Settings" class="button button-primary javo_btn_ts_save" type="button">

			</div>
			
			<img src="https://s.gravatar.com/avatar/39aa0fff22808b478d21aff1a79a3446?s=80" />
			...
			foreach( $pages as $index => $page ){
				...
				require_once get_template_directory()."/library/admin/assets/theme-settings"."-".$index.".php";
	...
	public function create_css($args=NULL){
		...
		printf("html, body, div, header, footer, article, section, form, input, select, textarea, label, ul, li, dl, dt, dd, span, p{font:%spx/%spx '%s';}\n",
